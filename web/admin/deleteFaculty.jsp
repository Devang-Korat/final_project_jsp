...
<%
    ...
    // Faculty details
    String name = "", email = "", phone = "", department = "", subjects = "";
    ...
    try {
        ...
        // Fetch faculty details and subjects
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="profile-card">
            ...
            <% } else { %>
                <h5 class="text-danger mb-3"><i class="bi bi-exclamation-triangle-fill me-2"></i>Are you sure you want to delete this faculty member?</h5>
                <hr>

                <div class="row">
                    <div class="col-md-6">
                        <div class="data-item"><span class="data-label">Faculty ID:</span> <span class="data-value"><%= facultyId %></span></div>
                    ...
                    <div class="col-md-6">
                        <div class="data-item"><span class="data-label">Department:</span> <span class="data-value"><%= department %></span></div>
                        <div class="data-item"><span class="data-label">Subjects:</span> <span class="data-value"><%= subjects.replaceAll(", ", "<br>") %></span></div>
                    </div>
                </div>

                <form action="removeFaculty.jsp" method="post" class="text-end mt-4">
                    <input type="hidden" name="faculty_id" value="<%= facultyId %>">
                    <button type="submit" class="btn-delete"><i class="bi bi-trash3-fill me-2"></i>Delete Faculty</button>
                    <a href="Faculty.jsp" class="btn-cancel"><i class="bi bi-arrow-left-circle me-2"></i>Cancel</a>
                </form>
            <% } %>
        </div>
    </div>
