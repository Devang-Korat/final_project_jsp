            ...
            <form action="updateStudent.jsp" method="post">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="enrollment" value="<%= enrollment %>" required>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="text-end mt-4">
                    ...
                    <a href="Students.jsp" class="btn-back"><i class="bi bi-arrow-left-circle me-2"></i>Back</a>
                </div>
            </form>
        </div>
    </div>
