...
<%
    ...
    try {
        ...
        // Join Students table (assuming course = class name)
        ps = con.prepareStatement(
            "SELECT student_id, Enrollment, name AS student_name, course FROM students ORDER BY Enrollment ASC"
        );
        rs = ps.executeQuery();
%>
            ...
            <table class="table table-bordered table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn-action btn-view" onclick="window.location.href='viewStudent.jsp?id=<%= rs.getInt("student_id") %>'"><i class="bi bi-eye"></i> View</button>
                            <button class="btn-action btn-edit" onclick="window.location.href='editStudent.jsp?id=<%= rs.getInt("student_id") %>'"><i class="bi bi-pencil"></i> Edit</button>
                            <button class="btn-action btn-delete" onclick="if(confirm('Are you sure you want to delete this student?')) window.location.href='deleteStudent.jsp?id=<%= rs.getInt("student_id") %>'"><i class="bi bi-trash"></i> Delete</button>
                        </td>
                    </tr>
                    <% } %>
                </tbody>
