    ...
    <div class="main-content">
        ...
        <div class="profile-card">
            <div class="profile-header">
                <h3><i class="bi bi-person-fill me-2"></i> <%= name %></h3>
            </div>
            ...
            <div class="profile-body">
                ...
                <% } else { %>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="data-item">
                                <span class="data-label"><i class="bi bi-hash me-2"></i>Enrollment Number:</span>
                                <span class="data-value"><%= enrollment %></span>
                            </div>
                            <div class="data-item">
                        ...
                        <div class="col-md-6">
                            <div class="data-item">
                                <span class="data-label"><i class="bi bi-book-fill me-2"></i>Course:</span>
                                <span class="data-value"><%= course %></span>
                            </div>
                            <div class="data-item">
                                <span class="data-label"><i class="bi bi-geo-alt-fill me-2"></i>Class:</span>
                                <span class="data-value"><%= className %></span>
                            </div>
                            <div class="data-item">
                                <span class="data-label"><i class="bi bi-calendar-range me-2"></i>Semester:</span>
                                <span class="data-value"><%= semester %></span>
                            </div>
                        </div>
                    </div>
                <% } %>
                ...
                <div class="text-end mt-4">
                    <button class="btn-back" onclick="window.location.href='Students.jsp'">
                        <i class="bi bi-arrow-left-circle me-2"></i> Back to Manage Students
                    </button>
                </div>
            </div>
        </div>
